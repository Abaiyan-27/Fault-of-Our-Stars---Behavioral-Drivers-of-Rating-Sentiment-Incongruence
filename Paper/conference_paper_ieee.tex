...
\begin{itemize}
    ...
    \item \textit{User\_Country} and \textit{User\_Locale} were excluded
    because they were sparse and inconsistently formatted.
...
\end{itemize}
The final explanatory design matrix contained 24 predictors: 10 venue-type
dummies, 7 province dummies, 3 reviewer-tier dummies, and 4 continuous terms
