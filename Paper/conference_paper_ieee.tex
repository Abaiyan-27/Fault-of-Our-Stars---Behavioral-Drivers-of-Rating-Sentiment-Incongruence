...
\textit{cardiffnlp/twitter-roberta-base-sentiment} model was selected because it
gave the best overall balance across metrics. Fine-tuned RoBERTa-base achieved a
slightly higher Macro F1, but Cardiff produced higher accuracy and weighted F1.
