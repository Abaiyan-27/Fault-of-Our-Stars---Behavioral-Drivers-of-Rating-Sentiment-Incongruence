...
differ in sentiment. The phases are: (1) data collection and cleaning,
...
\midrule
1 & Data Cleaning       & Rule-based normalization, feature engineering          & Clean 16,156-review dataset \\
...
transformer-based models were compared. A set of 1,000 reviews was labelled
manually and split into 700 for training and 300 for testing. The review title and
body were joined together as input, and long reviews were handled by splitting them
into chunks and averaging the results. Macro F1 was used as the main evaluation
measure because the three sentiment classes were not equally represented.
...
(Accuracy $= 0.83$, Macro F1 $= 0.6918$) and was selected to label all 16,156
reviews. Using a pretrained model also makes the results easier to reproduce.
