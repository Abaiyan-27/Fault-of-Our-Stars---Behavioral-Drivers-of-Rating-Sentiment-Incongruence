...
\textit{Rating\_Class} grouped star ratings into Positive
(4--5$\star$), Neutral (3$\star$), and Negative (1--2$\star$), following common
...
\textit{User\_Contributions} into Novice (0--5), Casual (6--20), Active
(21--100), and Expert (101+). Contributions were highly skewed
