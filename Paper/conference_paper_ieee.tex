...
were concatenated as model input. Performance was compared using Macro F1,
...
The final phase combined statistical testing, predictive modelling, and model
interpretation. Variable treatment was as follows:
\begin{itemize}
