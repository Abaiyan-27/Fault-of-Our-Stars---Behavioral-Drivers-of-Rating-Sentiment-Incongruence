...
Methodological advances have significantly increased the capabilities of sentiment analysis. Wen et al. \cite{ref10} demonstrated the effectiveness of the transformer-based models like Bidirectional Encoder Representations from Transformer (BERT) and Enhanced Representation through Knowledge Integration (ERNIE), while Puh and Bagic Babac \cite{ref11} has shown that predicting both sentiment and the ratings has given more deeper understanding. A multilingual approach along with an aspect based approach will make interpretation much easier \cite{ref13,ref14}. Moreover, some recent zeroshot approaches help to analyze uncommon data without providing any additional information \cite{ref15}.
